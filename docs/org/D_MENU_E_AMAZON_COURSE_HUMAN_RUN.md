...
**ダイアログ方針（2026-07-26）**: E-1〜E-4 は **成功時に OK 確認を出さない**（画面右下 toast ＋ Logger）。**エラーで止まったときだけ**原因の alert。E-0（前提一覧）と E-5（subBatchId入力）と案内メニューは従来どおり。C-Amazon／Z-21 単独実行の確認ダイアログは変更なし。
