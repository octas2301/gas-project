...
**承認**: [LV4_SPAPI_GAS_PUT_APPROVAL.md](LV4_SPAPI_GAS_PUT_APPROVAL.md)（第1段）／[LV4_SPAPI_GAS_PUT_STAGE2_APPROVAL.md](LV4_SPAPI_GAS_PUT_STAGE2_APPROVAL.md)（第2段・**承認済＝実装待ち**）  
...
| **21-⑪** prod（ALLOW_PROD 時のみ） | 承認①一括直呼び（第2段・**承認済／メニュー未実装**） |
